    ...
    <head>
        ...
        <body>
            ...
            <form role="search" class="header-form">
                <a class="mealGroup-link" href="<c:url value="/food/foodPage.do"/>">
                    Tạo mâm cơm mới
                </a>
                ...
                <c:if test="${not empty user }">
                    <a class="btn-header" style="cursor: pointer"
                       href="<c:url value="/user/about.do?account=${user.account}"/>">Xin chào: ${user.account}</a>
